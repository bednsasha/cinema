      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black py-20">
        <div className="container mx-auto px-6 max-w-2xl">
          <div className="bg-yellow-900/30 border border-yellow-500 rounded-xl p-8 text-center">
            ...
            <button onClick={() => navigate('/')} className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg font-semibold text-white">
              На главную
            </button>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black py-20">
        <div className="container mx-auto px-6 max-w-2xl">
          <div className="bg-gray-800 rounded-xl p-12 text-center">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Нет активных билетов</h1>
            <p className="text-gray-400 mb-6">У вас нет активных билетов на данный момент</p>
            <button onClick={() => navigate('/')} className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg font-semibold text-white">
              На главную
            </button>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black py-20">
      <div className="container mx-auto px-6 max-w-2xl">
        ...
        <div className="flex gap-4 mt-6">
          <button onClick={() => navigate('/profile')} className="flex-1 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg font-semibold text-white hover:opacity-90 transition">
            Все мои билеты
          </button>
          <button onClick={() => navigate('/')} className="flex-1 py-3 bg-gray-700 rounded-lg font-semibold text-white hover:bg-gray-600 transition">
            На главную
          </button>
        </div>
      </div>
